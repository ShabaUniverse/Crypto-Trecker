      ...
      <div className="container max-w-6xl mx-auto">
        <div className="wrapper px-2 flex flex-col justify-center items-center">
          <div className="rootInfo flex flex-col items-start w-full py-5 ">
            ...
            <p className=" text-xl text-gray-400 mt-12">Home / Sell Crypto</p>
          </div>
          ...
          <div className="steps w-full flex flex-col my-5">
            ...
            <p className=" font-semibold">Payment Fills</p>
          ...
          <div className=" py-10 mt-10 flex flex-col items-center bg-white rounded-xl w-[90%] md:w-[70%]">
            ...
            <p className=" font-medium my-7">
              You successfully sold 1.312 BTC for Rockie!
            </p>
